-- SkyZen Arsenal Aimlock + ESP Script dengan Rayfield GUI
...
local Window = Rayfield:CreateWindow({
    ...
    LoadingSubtitle = "by SkyZenScript10",
    ConfigurationSaving = {
        Enabled = true,
...
-- ===== INFO TAB =====
InfoTab:CreateLabel("🎮 KONTROL KEYBOARD:")
InfoTab:CreateLabel("E - Toggle ESP")
InfoTab:CreateLabel("L - Toggle Aimlock")
InfoTab:CreateLabel("O - Toggle Lane")
InfoTab:CreateLabel("T - Toggle Team Check")
...
InfoTab:CreateLabel("Version: 2.0 FIXED")
